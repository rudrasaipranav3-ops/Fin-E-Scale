...
export default function DashboardPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#050816] text-white">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-[min(285px,calc(100vw-1rem))] border-r border-white/10 bg-[#070b18]/95 p-4 backdrop-blur-2xl sm:w-[285px] sm:p-5 transition-transform lg:translate-x-0 ${
      ...
      <div className="relative z-10 min-h-screen lg:pl-[285px]">
        <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-white/10 bg-[#050816]/80 px-4 backdrop-blur-2xl sm:h-20 sm:px-5 md:px-8">
          ...
          <div className="flex items-center gap-3">
            <div className="relative hidden md:block">
              ...
              <input
                ...
                className="h-10 w-56 cursor-not-allowed rounded-xl border border-white/10 bg-white/5 pl-10 pr-4 text-sm text-gray-400 outline-none placeholder:text-gray-400"
              />
            </div>
      ...
      <div className="mt-6">
        <DashboardCard>
          ...
          {loading ? (
            ...
            <div className="mt-6 dashboard-table-scroll overflow-x-auto">
        ...
        <>
          ...
          <div className="mt-6">
            <DashboardCard>
              ...
              <div className="mt-6 dashboard-table-scroll overflow-x-auto rounded-xl border border-white/5">
