        ...
        <div className="mx-3 mt-3 shrink-0 rounded-xl border border-red-500/20 bg-red-500/[0.06] p-3">
          <div className="flex items-start gap-2">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 text-[11px] leading-4 text-red-300/70">{error}</p>
            </div>
            <button
              type="button"
              onClick={onRefresh}
              disabled={loading}
              className="shrink-0 rounded-md px-2 py-1 text-[10px] font-medium text-red-200 transition hover:bg-red-500/10 disabled:opacity-50"
            >
              Retry
            </button>
          </div>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain p-2 [scrollbar-width:thin] [scrollbar-color:rgba(139,92,246,.35)_transparent]">
        {loading && notifications.length === 0 ? (
          ...
          <div className="flex min-h-[300px] flex-col items-center justify-center px-6 py-12 text-center">
            ...
            <p className="mt-1.5 max-w-[250px] text-xs leading-5 text-gray-600">
            ...
            <button
              ...
              onClick={onRefresh}
              disabled={loading}
              className="mt-4 inline-flex items-center gap-1.5 rounded-lg border border-white/10 bg-white/[0.03] px-3 py-2 text-[11px] font-medium text-gray-400 transition hover:border-violet-500/20 hover:bg-violet-500/[0.06] hover:text-gray-200 disabled:opacity-50"
            >
                        ...
                        <div className="flex items-center gap-1 opacity-100 sm:opacity-0 sm:transition-opacity sm:group-hover:opacity-100 sm:group-focus-within:opacity-100">
                          {!notification.read && (
                            <button
                              ...
                              disabled={busy}
                              className="rounded-md border border-transparent p-1.5 text-gray-500 transition hover:border-green-500/10 hover:bg-green-500/10 hover:text-green-300 disabled:cursor-not-allowed disabled:opacity-50"
                              title="Mark as read"
                          ...
                          <button
                            ...
                            disabled={busy}
                            className="rounded-md border border-transparent p-1.5 text-gray-500 transition hover:border-red-500/10 hover:bg-red-500/10 hover:text-red-300 disabled:cursor-not-allowed disabled:opacity-50"
