...
export default function DashboardPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#050816] text-white">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-[min(300px,calc(100vw-1rem))] border-r border-white/10 bg-[#070b18]/95 p-4 backdrop-blur-2xl sm:w-[285px] sm:p-5 transition-transform duration-200 ease-out lg:translate-x-0 ${
      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold">Fin E-Scale</p>
        ...
        <nav className="mt-7 space-y-1.5 sm:mt-9 sm:space-y-2">
        ...
        <div className="absolute bottom-5 left-5 right-5">
          ...
          <button
            ...
            className="mb-2 flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm text-white/70 transition hover:bg-white/5 hover:text-white"
          >
      ...
      <div className="relative z-10 min-h-screen min-w-0 overflow-x-clip lg:pl-[285px]">
        <header className="sticky top-0 z-20 flex h-16 min-w-0 items-center justify-between border-b border-white/10 bg-[#050816]/80 px-4 backdrop-blur-2xl sm:h-20 sm:px-5 md:px-8">
          <div className="flex min-w-0 items-center gap-3 sm:gap-4">
            ...
            <div className="min-w-0">
              ...
              <h1 className="truncate text-sm font-semibold sm:text-base">{getPageTitle(activeTab)}</h1>
            </div>
          </div>
          ...
          <div className="flex shrink-0 items-center gap-2 sm:gap-3">
            <div className="relative hidden sm:block">
              ...
              <input
                ...
                className="h-10 w-48 cursor-not-allowed rounded-xl sm:w-56 border border-white/10 bg-white/5 pl-10 pr-4 text-sm text-gray-400 outline-none placeholder:text-gray-400"
              />
            </div>
              ...
              <button
                ...
                className={`relative flex h-10 w-10 items-center justify-center rounded-xl border transition ${
                  notificationsOpen
                    ...
                    : "border-white/10 bg-white/5 text-gray-300 hover:border-violet-500/30 hover:bg-violet-500/10 hover:text-white"
                }`}
              >
                <Bell className="h-5 w-5" />
                {unreadNotificationCount > 0 && (
                  <span className="absolute -right-1 -top-1 flex min-w-5 items-center justify-center rounded-full border-2 border-[#050816] bg-red-500 px-1 text-[10px] font-bold leading-4 text-white shadow-lg shadow-red-500/20">
      ...
      <div className="mt-6">
        <DashboardCard>
          ...
          {loading ? (
            ...
            <div
              className="mt-6 dashboard-table-scroll rounded-lg border border-white/5"
              tabIndex={0}
              role="region"
              aria-label="Product performance table. Scroll horizontally to view all columns."
            >
              <div className="flex min-w-max items-center justify-end border-b border-white/5 bg-white/[0.02] px-3 py-1.5 text-[10px] font-medium text-gray-500 sm:hidden">
                Swipe horizontally to view all columns
              </div>
              <table className="w-max min-w-[800px] whitespace-nowrap text-left text-sm">
                <thead>
        ...
        <DashboardCard>
          ...
          {loading ? (
            ...
            <div
              ...
              tabIndex={0}
              role="region"
              aria-label="Recent orders table. Scroll horizontally to view all columns."
            >
              <div className="flex min-w-max items-center justify-end border-b border-white/5 bg-white/[0.02] px-3 py-1.5 text-[10px] font-medium text-gray-500 sm:hidden">
                Swipe horizontally to view all columns
              </div>
        ...
        <DashboardCard>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">K-Means customer groups</p>
            </div>
          </div>
  ...
  return (
    <DashboardCard>
      <div className="flex items-start justify-between gap-4">
        ...
        <span className={`rounded-full border px-2.5 py-1 text-[11px] sm:text-xs ${badgeClass}`}>
          {badge}
        </span>
      </div>
...
function NotificationDropdown({
  ...
  return (
    <div
      ...
      className="fixed inset-x-3 top-[4.75rem] z-50 flex max-h-[calc(100dvh-6rem)] flex-col overflow-hidden rounded-2xl border border-white/10 bg-[#090d1d]/[0.98] shadow-2xl shadow-black/50 backdrop-blur-2xl sm:absolute sm:right-0 sm:top-12 sm:inset-x-auto sm:w-[390px] sm:max-h-[min(70vh,560px)]"
    >
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              ...
              {unreadCount > 0 && (
                <span className="rounded-full border border-violet-500/20 bg-violet-500/10 px-2 py-0.5 text-[10px] font-semibold sm:text-[11px] text-violet-300">
                  {unreadCount} new
                </span>
              )}
            </div>
            <p className="mt-1 text-[11px] text-gray-400 sm:text-xs">
              {unreadCount > 0
                ? `${unreadCount} unread · ${notificationCountLabel}`
                : notifications.length > 0
                  ? `All caught up · ${notificationCountLabel}`
                  : "Forecast alerts and recommendations appear here"}
            </p>
          </div>
          ...
          <div className="flex shrink-0 items-center gap-1">
            <button
              ...
              className="rounded-lg p-2 text-gray-400 transition hover:bg-white/5 hover:text-white disabled:cursor-not-allowed disabled:opacity-40"
            ...
            {unreadCount > 0 && (
              <button
                ...
                disabled={actionId === "all" || loading}
                className="rounded-lg border border-violet-500/10 bg-violet-500/[0.04] px-2.5 py-1.5 text-[11px] font-medium text-violet-300 transition hover:border-violet-500/20 hover:bg-violet-500/10 hover:text-violet-200 disabled:cursor-not-allowed disabled:opacity-50"
              >
      ...
      {error && (
        <div className="mx-3 mt-3 shrink-0 rounded-xl border border-red-500/20 bg-red-500/[0.06] p-3">
          <div className="flex items-start gap-2">
            <div className="mt-0.5 h-1.5 w-1.5 shrink-0 rounded-full bg-red-400" />
            <div className="min-w-0 flex-1">
              <p className="text-xs font-medium text-red-300">Couldn't load notifications</p>
              <p className="mt-1 text-[11px] leading-4 text-red-300/80 sm:text-xs">{error}</p>
            </div>
            <button
              type="button"
              onClick={onRefresh}
              disabled={loading}
              className="shrink-0 rounded-md px-2 py-1 text-[10px] font-medium text-red-200 sm:text-[11px] transition hover:bg-red-500/10 disabled:opacity-50"
            >
              Retry
            </button>
          </div>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain p-2 [scrollbar-width:thin] [scrollbar-color:rgba(139,92,246,.35)_transparent]">
        {loading && notifications.length === 0 ? (
          <div className="space-y-2 px-1 py-3">
            {[0, 1, 2].map((item) => (
              <div
                key={item}
                className="animate-pulse rounded-xl border border-white/5 bg-white/[0.025] p-3"
              >
          ...
          <div className="flex min-h-[300px] flex-col items-center justify-center px-6 py-12 text-center">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-violet-500/10 bg-violet-500/[0.06]">
              <Bell className="h-6 w-6 text-violet-400/70" />
            </div>
            <p className="mt-4 text-sm font-semibold text-gray-200">You're all caught up</p>
            <p className="mt-1.5 max-w-[250px] text-xs leading-5 text-gray-400">
              There are no notifications right now. New forecast risks and recommendations will appear here.
            </p>
            <button
              type="button"
              onClick={onRefresh}
              disabled={loading}
              className="mt-4 inline-flex items-center gap-1.5 rounded-lg border border-white/10 bg-white/[0.03] px-3 py-2 text-[11px] font-medium text-gray-400 sm:text-xs transition hover:border-violet-500/20 hover:bg-violet-500/[0.06] hover:text-gray-200 disabled:opacity-50"
            >
              ...
              return (
                <div
                  ...
                  className={`group relative rounded-xl border p-3 transition ${
                    notification.read
                      ? "border-transparent bg-transparent opacity-80 hover:border-white/5 hover:bg-white/[0.035] hover:opacity-100"
                      : "border-violet-500/15 bg-violet-500/[0.045] shadow-sm shadow-violet-950/10 hover:border-violet-500/25 hover:bg-violet-500/[0.065]"
                  }`}
                >
                  {!notification.read && (
                    <span
                      className="absolute bottom-3 left-1 top-3 w-0.5 rounded-full bg-violet-400"
                      aria-hidden="true"
                    />
                  )}
                  ...
                  <div className="flex gap-3 pl-1">
                    <div
                      className={`mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border ${
                        notification.read
                          ? "border-white/5 bg-white/[0.03] text-gray-400"
                          : `${priorityClass} border-white/5`
                      }`}
                    >
                      ...
                      <div className="flex items-start justify-between gap-2">
                        <div className="min-w-0">
                          ...
                          <div className="mt-1 flex items-center gap-1.5">
                            {!notification.read ? (
                              <span className="rounded-full bg-violet-500/10 px-1.5 py-0.5 text-[9px] font-semibold uppercase tracking-wide text-violet-300">
                                Unread
                              </span>
                            ) : (
                        ...
                        {!notification.read && (
                          <span
                            className="mt-1 h-2 w-2 shrink-0 rounded-full bg-violet-400 shadow-sm shadow-violet-400/50"
                            aria-label="Unread"
                          />
                        )}
                      </div>
                        ...
                        <div className="flex items-center gap-1 opacity-100 sm:opacity-0 sm:transition-opacity sm:group-hover:opacity-100 sm:group-focus-within:opacity-100">
                          {!notification.read && (
                            <button
                              ...
                              disabled={busy}
                              className="rounded-md border border-transparent p-1.5 text-gray-400 transition hover:border-green-500/10 hover:bg-green-500/10 hover:text-green-300 disabled:cursor-not-allowed disabled:opacity-50"
                              title="Mark as read"
                          ...
                          <button
                            ...
                            disabled={busy}
                            className="rounded-md border border-transparent p-1.5 text-gray-400 transition hover:border-red-500/10 hover:bg-red-500/10 hover:text-red-300 disabled:cursor-not-allowed disabled:opacity-50"
        ...
        <DashboardCard>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Express → FastAPI</p>
            </div>
          </div>
      ...
      <div className="mt-6 grid gap-5 xl:grid-cols-[0.72fr_1.28fr]">
        ...
        <DashboardCard>
          ...
          {loading ? (
            ...
            <div className="mt-6 dashboard-table-scroll touch-pan-x overflow-x-auto rounded-lg">
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#050816] text-white">
      ...
      >
        ...
        <p className="mt-2 text-sm text-gray-400">Verifying secure session.</p>
      </motion.div>
    </main>
  );
}
              ...
              <div className="mt-6 flex flex-col gap-3 lg:flex-row lg:items-center lg:gap-4">
                <div className="relative w-full lg:max-w-xs">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-white/10 bg-white/5 py-2.5 pl-9 pr-3 text-sm text-gray-200 placeholder:text-gray-400 outline-none transition focus:border-violet-500/40"
                  />
                </div>
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          ...
                          <span className="mt-1.5 inline-block rounded-full border border-cyan-500/20 bg-cyan-500/10 px-2.5 py-0.5 text-[10px] font-medium uppercase tracking-wide text-cyan-300 sm:text-[11px]">
                            {row.product.category}
                          </span>
                        </div>
                        {isTopScore && (
                          <span className="shrink-0 rounded-full border border-violet-500/20 bg-violet-500/10 px-2.5 py-1 text-[10px] text-violet-300 sm:text-[11px] sm:text-[11px]">
                            Top Match
                          </span>
                        )}
                      </div>
                      ...
                      <div className="mt-5 rounded-xl border border-violet-500/10 bg-violet-500/[0.04] p-3">
                        <div className="flex gap-2">
                          ...
                          <div className="min-w-0">
                            <p className="text-[10px] font-semibold uppercase tracking-wider text-violet-400 sm:text-[11px]">
                              Why this product?
                            </p>
                            <p className="mt-1 text-xs leading-5 text-gray-400">
        ...
        <>
              ...
              <div className="flex flex-col justify-between gap-3 md:flex-row md:items-center">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="rounded-full bg-cyan-400/10 px-2 py-1 text-[10px] font-medium uppercase tracking-wide text-cyan-300 sm:text-[11px] sm:text-[11px]">
          ...
          <div className="mt-6">
            <DashboardCard>
              ...
              {filteredHistory.length === 0 ? (
                <div className="mt-5 rounded-xl border border-dashed border-white/10 bg-white/[0.02] px-5 py-7 text-center">
                  ...
                  <div className="mt-3 flex flex-col items-center gap-2 sm:flex-row sm:justify-center">
                    <div className="inline-flex items-center rounded-full border border-white/10 bg-white/[0.035] px-3 py-1.5 text-[11px] font-medium text-gray-400 sm:text-xs">
                      {data?.historyPoints ?? 0} historical points available to the forecast pipeline
                    </div>

                    <a
                      href="#forecast-details"
                      className="inline-flex items-center rounded-lg border border-violet-400/20 bg-violet-500/[0.08] px-3 py-1.5 text-[11px] font-medium text-violet-200 sm:text-xs transition hover:border-violet-400/35 hover:bg-violet-500/[0.14]"
                    >
              ...
              <div className="mt-6 dashboard-table-scroll touch-pan-x overflow-x-auto rounded-xl border border-white/5">
...
function ForecastChart({
  ...
  return (
    <div className="mt-8 h-[380px] w-full">
      ...
      <div className="mt-3 flex flex-wrap items-center justify-center gap-5 text-xs text-gray-400">
        <div className="flex items-center gap-2">
